#!/usr/bin/env python3
"""
BASTION v5 LoRA Merge Script
==============================
Run AFTER finetune_v4.py completes (separate process to avoid OOM).
  /opt/sys-venv/bin/python3 /workspace/merge_v5.py
"""
...
BASE_MODEL = "/root/models/bastion-risk-v3-merged"
LORA_DIR = "/workspace/bastion-risk-v5-lora"
...
print(f"    --host 0.0.0.0 --port 8000 > /workspace/vllm_v5.log 2>&1 &")
