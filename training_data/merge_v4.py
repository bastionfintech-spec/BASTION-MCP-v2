#!/usr/bin/env python3
"""
BASTION v4 LoRA Merge Script
==============================
Run AFTER finetune_v4.py completes (separate process to avoid OOM).
  /opt/sys-venv/bin/python3 /workspace/merge_v4.py
"""
...
LORA_DIR = "/workspace/bastion-risk-v4-lora"
...
print(f"    --host 0.0.0.0 --port 8000 > /workspace/vllm_v4.log 2>&1 &")
