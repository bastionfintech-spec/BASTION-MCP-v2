#!/usr/bin/env python3
"""
BASTION v5 QLoRA Fine-Tune Script
==================================
Run on GPU cluster (4x RTX 5090):
  1. Upload this file + bastion_risk_v5_combined.jsonl to /workspace/
  2. Stop vLLM: pkill -f vllm
  3. Run: /opt/sys-venv/bin/python3 /workspace/finetune_v5.py
  4. After completion, run /workspace/merge_v5.py separately
...
TRAINING_DATA = "/workspace/bastion_risk_v5_combined.jsonl"
OUTPUT_DIR = "/workspace/bastion-risk-v5-lora"
MERGED_DIR = "/root/models/bastion-risk-v5-merged"
...
print("=" * 60)
print("BASTION v5 QLoRA Fine-Tune")
print("=" * 60)
...
print(f"  /opt/sys-venv/bin/python3 /workspace/merge_v5.py")
